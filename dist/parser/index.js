...
import { genAssignmentCode } from './shared/model.js';
import { extend, no, camelize, hyphenate, __DEV__ } from './shared/util.js';
import { isIE, isEdge, isServerRendering } from './core/util/env.js';
import { addProp, addAttr, baseWarn, addHandler, addDirective, getBindingAttr, getAndRemoveAttr, getRawBindingAttr, pluckModuleFunction, getAndRemoveAttrByRegex } from './helpers.js';
...
const convertHtmlStr2AST = (template) => {
    ...
    return parse(template, DefaultOptions);
};
export default convertHtmlStr2AST;
